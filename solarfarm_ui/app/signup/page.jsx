...
import { saveRequestSignUp, saveUserData } from "../actions/usersContractActions";
...
export default function SignUpPage() {
    ...
    const submitHandler = async (user) => {
        try {
            ...
            saveUserData(userData.toJSON(), uid);

            // If address doesn't exist, create and save authorization request

            if (!addressCheck.exists) {
                const authRequest = new AuthorizationRequest(uid, userData._ethereumAddress, {
                ...
                await saveRequestSignUp(authRequest.toJSON());
