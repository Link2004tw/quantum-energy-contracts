...
export default function SigningForm({
    ...
    const isSubmitDisabled =
        ...
        !formData.password ||
        (mode === "signUp" &&
            (!formData.username || !isWalletConnected || formData.password !== formData.confirmPassword)) ||
        (mode === "update" &&
            (!formData.email ||
                !formData.username ||
    ...
    return (
        <form className="py-4 px-7 bg-primary-600/5 rounded-md block min-w-fit w-full" onSubmit={handleSubmit}>
            {errorMessage && (
                <Modal
            ...
            <label className="block">
                ...
                <input
                    ...
                    placeholder={mode === "update" ? "Leave blank to keep current password" : ""}
            ...
            {(mode === "signUp" || mode === "update") && (
                <>
                    <label className="block">
                        <span className="text-primary-600 font-medium">Confirm Password</span>
                        <input
                            type="password"
                    ...
                    {isWalletConnected ? (
                        <div className="text-center text-primary-600 my-4">
                            Connected Wallet: {truncateEthereumAddress(formData.ethereumAddress)}
                            <div className="pt-4">
