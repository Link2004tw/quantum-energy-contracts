...
async function main() {
  ...
  // "0x694AA1769357215DE4FAC081bf1f309aDC325306", "0x3998FF27EB77a6f29b4b4624d6F785264E43f5eF","0x2226261b197522D0904fF3D326b43051E1494927","0xf9602f536496e4473f391f0045e1ad4d1dc2ea9d", 5575, "0x66756e2d657468657265756d2d7365706f6c69612d3100000000000000000000"
  ...
  const energyContract = await EnergyContract.deploy(
    priceFeedAddress,
    "0x3998FF27EB77a6f29b4b4624d6F785264E43f5eF",
    {
      gasLimit: 7000000,
    }
  );
  ...
  await energyContract
    .connect(deployer)
    .authorizeParty("0x70997970C51812dc3A010C7d01b50e0d17dc79C8");
  const answer = await energyContract.checkAuthState(
